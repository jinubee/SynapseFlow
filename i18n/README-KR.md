...
SynapseFlow는 단일 리포지토리에 3개의 서로 다른 모듈이 있습니다.
...
SynapseFlow는 인스턴스 구성을 위한 다양한 환경 변수를 지원합니다. `packages/server` 폴더 내 `.env` 파일에 다양한 환경 변수를 지정할 수 있습니다. [자세히 보기](https://github.com/SynapseFlowAI/SynapseFlow/blob/main/CONTRIBUTING.md#-env-variables)

## 📖 공식 문서

[SynapseFlow 문서](https://docs.SynapseFlowai.com/)

## 🌐 자체 호스팅 하기

기존 인프라 환경에서 SynapseFlow를 자체 호스팅으로 배포하세요. 다양한 배포 [deployments](https://docs.SynapseFlowai.com/configuration/deployment) 방법을 지원합니다.
...
[SynapseFlow Cloud 시작하기](https://SynapseFlowai.com/)

## 🙋 기술 지원

질문, 버그 리포팅, 새로운 기능 요청 등은 [discussion](https://github.com/SynapseFlowAI/SynapseFlow/discussions) 섹션에서 자유롭게 이야기 해주세요.
