    ...
    async run(nodeData: INodeData, input: string | Record<string, any>, options: ICommonObject): Promise<any> {
        ...
        try {
            ...
            for (const tool of tools) {
                ...
                const newNodeData = {
                    ...nodeData,
                    credential: toolConfig['SynapseFlow_CREDENTIAL_ID'],
                    inputs: {
                        ...nodeData.inputs,
                        ...toolConfig
                    }
            ...
            if (knowledgeBasesForVSEmbeddings && knowledgeBasesForVSEmbeddings.length > 0) {
                for (const knowledgeBase of knowledgeBasesForVSEmbeddings) {
                    ...
                    const newEmbeddingNodeData = {
                        ...nodeData,
                        credential: selectedEmbeddingModelConfig['SynapseFlow_CREDENTIAL_ID'],
                        inputs: {
                            ...nodeData.inputs,
                    ...
                    const newVSNodeData = {
                        ...nodeData,
                        credential: selectedVectorStoreConfig['SynapseFlow_CREDENTIAL_ID'],
                        inputs: {
                            ...nodeData.inputs,
            ...
            const newNodeData = {
                ...nodeData,
                credential: modelConfig['SynapseFlow_CREDENTIAL_ID'],
                inputs: {
                    ...nodeData.inputs,
                    ...modelConfig
                }
