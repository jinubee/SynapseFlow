...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/SynapseFlow-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'SynapseFlow-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<SynapseFlow-fullchatbot></SynapseFlow-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/SynapseFlow-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "SynapseFlow-embed-react"
...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://SynapseFlowai.com/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
    ...
    chatWindow: {
        ...
        footer: {
            ...
            text: 'Powered by',
            company: 'SynapseFlow',
            companyLink: 'https://SynapseFlowai.com'
        }
    }
}
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/SynapseFlow-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/SynapseFlow-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
