    ...
    const handleSaveFlow = async (chatflowName) => {
        if (reactFlowInstance) {
            const nodes = reactFlowInstance.getNodes().map((node) => {
                ...
                if (Object.prototype.hasOwnProperty.call(nodeData.inputs, SynapseFlow_CREDENTIAL_ID)) {
                    nodeData.credential = nodeData.inputs[SynapseFlow_CREDENTIAL_ID]
                    nodeData.inputs = omit(nodeData.inputs, [SynapseFlow_CREDENTIAL_ID])
                }
                node.data = {
                    ...nodeData,
                    selected: false
