...
export class AccountController {
    ...
    public async getBasicAuth(req: Request, res: Response) {
        if (process.env.SynapseFlow_USERNAME && process.env.SynapseFlow_PASSWORD) {
    ...
    public async checkBasicAuth(req: Request, res: Response) {
        ...
        if (username === process.env.SynapseFlow_USERNAME && password === process.env.SynapseFlow_PASSWORD) {
